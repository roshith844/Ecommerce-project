...
router.get(
  "/wishlist",
  SESSION_MANAGER.verifyLoginUser,
...
router.get(
  "/cart/edit-cart/:id",
  SESSION_MANAGER.verifyLoginUser,
  userController.viewEditQuantity
);
router.post(
...
router.get(
  "/checkout",
  SESSION_MANAGER.verifyLoginUser,
  userController.viewCheckout
);
router.get(
  "/checkout/add-address",
  SESSION_MANAGER.verifyLoginUser,
  userController.viewAddAddress
);
router.post(
  "/checkout/add-address",
  SESSION_MANAGER.verifyLoginUser,
...
router.get(
  "/payment-success/:id",
  SESSION_MANAGER.verifyLoginUser,
  userController.showPaymentSuccess
);
router.get(
  "/payment-failed/:id",
  SESSION_MANAGER.verifyLoginUser,
  userController.showPaymentFailed
);
...
router.get(
  "/profile/add-address",
  SESSION_MANAGER.verifyLoginUser,
  userController.profileViewAddAddress
);
router.post(
  "/profile/add-address",
  SESSION_MANAGER.verifyLoginUser,
  userController.addProfileAddress
);
router.get(
  "/profile/change-password",
  SESSION_MANAGER.verifyLoginUser,
  userController.viewChangePassword
);
router.post(
  "/profile/change-password",
  SESSION_MANAGER.verifyLoginUser,
...
router.get(
  "/orders",
  SESSION_MANAGER.verifyLoginUser,
  userController.viewOrdersToUser
);
router.get(
  "/orders/cancel/:id",
  SESSION_MANAGER.verifyLoginUser,
  userController.cancelOrderByUser
);
router.get(
  "/orders/details/:id",
  SESSION_MANAGER.verifyLoginUser,
